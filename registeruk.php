...
<div class="index text-center">
  ...
  <form action="registeruk.php" method="post">
   <?php include('errors.php'); ?>
   <center>
   <div class="form-group">
      <label for="pwd">Name:</label>
      <input type="text" class="form-control" id="pwd" placeholder="Enter Name" name="username" value="<?php echo $username; ?>">
    </div><div class="form-group">
      <label for="pwd">Surname:</label>
      <input type="text" class="form-control" id="pwd" placeholder="Enter Surname" name="surname"value="<?php echo $surname; ?>">
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
      <label for="pwd">Enter the passowrd again:</label>
